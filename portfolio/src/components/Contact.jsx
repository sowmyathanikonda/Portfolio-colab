  ...
  return (
    <section className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
        <button className="bg-black text-white px-5 sm:px-6 py-2 sm:py-3 rounded-full flex items-center gap-2 hover:bg-gray-800 text-sm sm:text-base transition-all">
          <Mail size={16} />
          Email Me
        </button>
        <button className="bg-gray-100 px-5 sm:px-6 py-2 sm:py-3 rounded-full flex items-center gap-2 hover:bg-gray-200 text-sm sm:text-base transition-all">
